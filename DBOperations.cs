...
namespace Team5Project.Models
{
    public class DBOperations
    {
        ...
        static Team5ProjectEntities7 v = new Team5ProjectEntities7();
        ...
        public static string AdminApproveToBA(string bstatus, string bid)//Admin approve requests of BA
        {
            ...
            bvr.Status = bstatus;
            // bvr.No_of_Vehicles_Approved = nov;
            v.SaveChanges();
            return "APPROVED";
